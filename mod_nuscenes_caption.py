...
def main(nuscenes_dir: str, json_dir: str):
    ...
    # fine_tuned_weights_path = "/workspace/blip2_mod/lavis/output/BLIP2/Caption_coco/20231022060_opt_seed21/checkpoint_best.pth"
    ...
    # new_json_dir = "/workspace/nuScenes/v1.0-trainval/image_annotations_with_caption.json"
    new_json_dir = "/workspace/blip2_mod/docs/_static/nuscenes_test_seed2023.json"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_dir', default="/workspace/blip2_mod/docs/_static/nuscenes_test_seed21.json")
