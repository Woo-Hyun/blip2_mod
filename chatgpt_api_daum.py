...
def main(nuscenes_dir: str, json_dir: str):
    My_OpenAI_key = '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'
    ...
    for image_path, object_list in tqdm(data.items(), desc="Processing images", position=0):
        ...
        if image_count != 0 and image_count % 10000 == 0:
            with open(f"/workspace/nuScenes/v1.0-trainval/final_daum_1_{image_count}.json", "w") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_dir', default="/workspace/nuScenes/v1.0-trainval/rest_daum_1.json")
