...
new_json_dir = "/workspace/nuScenes/v1.0-trainval/image_annotations_with_caption_maneuver_fakecaption_arrange.json"
#new_json_dir = "/workspace/blip2_mod/docs/_static/maneuver_fake_filtered.json"
