...
def get_gt(info):
    ...
    for ann_info in info['ann_infos']:
        ...
        gt_tokens.append(ann_info['instance_token'])
    return gt_boxes, gt_labels, gt_tokens
...
def add_ann_adj_info(extra_tag):
    ...
    for set in ['train', 'val']:
        ...
        for id in range(len(dataset['infos'])):
            ...
            gt_boxes, gt_labels, gt_tokens = get_gt(dataset['infos'][id])
            dataset['infos'][id]['token'] = sample['token']
            dataset['infos'][id]['prev'] = sample['prev']
            dataset['infos'][id]['next'] = sample['next']
            dataset['infos'][id]['ann_infos'] = gt_boxes, gt_labels, gt_tokens
...
if __name__ == '__main__':
    ...
    extra_tag = 'bevdetv2-nuscenes-mini'
    nuscenes_data_prep(
        root_path=root_path,
